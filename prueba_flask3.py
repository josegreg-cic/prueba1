...
a un archivo JSON. El objeto contendra una lista con
un diccionario por cada posicion, donde cada diccionario
tendra cinco llaves:
I Fecha
II Titulo
III url
...
def imprime(categoria,words):
    ...
    responde = Response(json.dumps([noti for noti in car if noti['Categoria']==str(categoria)]), content_type = "application/json; charset=utf-8")
    return responde
